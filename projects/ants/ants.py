...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            # BEGIN Problem 8
            # print(type(self))
            # print(type(place.ant))
            # print('place.cancontain:', place.ant.can_contain(self))
            # print('self.cancontain:', self.can_contain(place.ant))
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while curr != beehive:
            if curr.bees:
                return bee_selector(curr.bees)  # REPLACE THIS LINE
            curr = curr.entrance
        # END Problem 3 and 4
...
class HungryAnt(Ant):
    ...
    def action(self, gamestate):
        if self.chewing == 0:
            if self.place.bees:
                curr = bee_selector(self.place.bees)
                curr.reduce_health(curr.health)
